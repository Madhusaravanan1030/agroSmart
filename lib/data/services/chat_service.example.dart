...
class ChatService {
  ...
  static const String _apiKey = 'Your_Groq_API_Key_Here'; // <-- Replace with your actual Groq API key
  static const String _apiUrl = 'https://api.groq.com/openai/v1/chat/completions';
  static const String _model  = 'llama-3.1-8b-instant'; // free, very fast (~300 tokens/sec)
...
$lang''';
  ...
  Future<String> sendMessage({
    ...
    // Build messages array — OpenAI format used by Groq
    final messages = <Map<String, String>>[
      // System prompt with farm context
      {
        'role': 'system',
